  ...
  return (
    <section className="menu-section">
      <div className="menu-layout">
        ...
        <div className="menu-content-blocks">
          ...
          <a href="/ruta/menu.pdf" target="_blank" rel="noopener noreferrer">
            <img src="/buttons/DescargarMenu.png"className='cta-img' alt="Descargar menú del evento" />
          </a>
